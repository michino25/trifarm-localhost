...
class login
{
    ...
    function createCaptcha($data)
    {
        ...
        $fonts = [
            $_SERVER["DOCUMENT_ROOT"] . $index2 . '/assets/fonts/fonts_captcha/Roboto-Black.ttf',
            $_SERVER["DOCUMENT_ROOT"] . $index2 . '/assets/fonts/fonts_captcha/Roboto-BoldItalic.ttf',
            $_SERVER["DOCUMENT_ROOT"] . $index2 . '/assets/fonts/fonts_captcha/Roboto-Medium.ttf',
            $_SERVER["DOCUMENT_ROOT"] . $index2 . '/assets/fonts/fonts_captcha/Roboto-Regular.ttf'
        ];
